<nav class="w-full bg-gray-950/75 backdrop-blur-md h-14 flex items-center">
    <div class="wrapper flex justify-between items-center">
        <a class="text-xl font-bold flex space-x-1 items-center group" href="{{ route('home') }}">
        ...
        <div class="flex space-x-4 text-sm text-gray-500 items-center">
            ...
            <a wire:navigate class="hover:text-primary-300" href="{{ route('posts.index') }}">Blog</a>
